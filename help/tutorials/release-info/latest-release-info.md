...
description: Senaste AEM och AEM versioner
exl-id: 780697a9-bdc6-40c2-b258-64639fe30f88
source-git-commit: fb83548e8c74f4b2ec723959d781240b95b9aee5
workflow-type: tm+mt
...
| **Referensgenerering** | Alla innehållsreferenser skapas baserat på deras sökvägar. | Alla innehållsreferenser skapas baserat på deras UUID. |
...
* UUID-bygget ser framåt, eftersom vi även använder det här ramverket för molnkonfiguration av AEM stödlinjer.
