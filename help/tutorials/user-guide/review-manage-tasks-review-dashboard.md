...
description: Lär dig hur du hanterar granskningsåtgärder med hjälp av Kontrollpanelen
...
1. Välj en granskningsuppgift.

   Du visas Redigera egenskaper och [Status](#check-review-status-id199RF0A0UHS) i verktygsfältet.

1. Om du klickar **Redigera egenskaper** visas sidan Uppgiftsinformation.
...
- Lägg till standardtilldelningar i **Tilldela till** nedrullningsbar lista. De granskare du lägger till härifrån får åtkomst till alla ämnen som ingår i denna granskningsuppgift. Du kan välja att ta bort eller selektivt lägga till fler granskare i specifika ämnen i [Fliken Granskare](#reviewer-tab-id199RF0N0MUI).
...
- Klicka **Slutförd** för att markera granskningsaktiviteten som slutförd före förfallodatumet. När ett enskilt temats uppgift har markerats som Fullständig stängs granskningen av det valda ämnet. Om ämnen delas för granskning via en DITA-karta och DITA-kartan markeras som fullständig, kommer dock granskningen av alla ämnen på kartan som delats för granskning att stängas.
- Klicka **Duplicera** om du vill skapa en kopia av granskningsaktiviteten. Processen att skapa en dubblettgranskningsuppgift påminner om att skapa en ny granskningsuppgift. När du har startat det duplicerade arbetsflödet visas sidan Skapa granskningsuppgift. Du måste ange den nya uppgiftsinformationen enligt [Skicka ämnen för granskning](review-send-topics-for-review.md#).
...
## Kontrollera status för en granskningsuppgift {#check-review-status-id199RF0A0UHS}
...
- Statuskolumnen anger granskningsstatusen. Status kan vara något av följande:
   ...
   - **Pågår**: Granskaren har öppnat granskningslänken och håller på att granska ämnet.
   - **Slutförd**: Granskaren har slutfört granskningen genom att slutföra den granskningsuppgift som tilldelats dem. Granskningsaktiviteten finns i AEM för varje granskare.
